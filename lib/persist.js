...
exports.defineAutoSane = function(name, info, options, defineOpts, callback) {
  ...
  if (info.tables.hasOwnProperty(pluralName)) {
    ...
    // defining defineOpts to be { tableName: 'lalala' }
    var model = Model.define(name, columnDefs, defineOpts);
    callback(null, model);
  };
};
